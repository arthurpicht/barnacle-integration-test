package de.arthurpicht.barnacleIntegrationTest.tg_01.tc_01;
 ...
 * Generate schema on db based on configured SingleJDBCConnection.
 * Test table creation.
 *
 */
...
public class TestCase0101 {
    ...
    void checkTableCreated() throws SQLException, DBConnectionException {
        BarnacleConfiguration barnacleConfiguration = createConfiguration();
        List<String> tableNameList = DbMeta.getTableNames(barnacleConfiguration, TestCase0101.class);
